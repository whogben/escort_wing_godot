...
## A standard forward-firing gatling laser.
...
func _fireshot():
	...
	var proj := Projectile.create_from_info("Standard Laser Pulse", ship.combat_team(), spawn_pos, final_rot, inertia)
	if proj:
